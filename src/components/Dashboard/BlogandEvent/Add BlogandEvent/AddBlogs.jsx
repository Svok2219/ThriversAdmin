...
const AddBlogs = () => {
  ...
  const HandleSubmit = async (e) => {
    ...
    await axios
      .post(
        `https://thrivers-assignment-server.onrender.com/ThrivesDailyRouter`,
        {
          BlogTitle: formElRecognize.current.elements[0].value,
          BlogWriter: formElRecognize.current.elements[1].value,
          // BlogDate: new Date().getUTCDate,
          Blog: formElRecognize.current.elements[2].value,
        }
      )
      .then((res) => {
        if (res.status === 200) {
      ...
      .catch((err) => {
        if (err.response?.status == 302) {
          setErrorMessage("Blogs with this email already exists");
                  ...
                  >
                    <div className="col-md-6 position-relative">
                      <label for="validationTooltip02" className="form-label">
                        Title/Headline of the New Blog
                      </label>
                      <input
                        type="text"
                        name="Title"
                    ...
                    <div className="col-md-12 position-relative">
                      ...
                      <div className="invalid-tooltip">
                        Write whatever you want to post
                      </div>
                    </div>
...
//     console.log("logloglaog");
//     await axios
//       .post(`https://thrivers-assignment-server.onrender.com/MentorshipRouter`, {
//         MentorshipProgramTitle: formEl.current.elements[0].value,
//         MentorshipProgramPriceDetail: formEl.current.elements[2].value,
//         MentorshipProgramImage: formEl.current.elements[1].value,
//       })
//       .then((res) => {
//         if (res.status === 201) {
//           setSuccess(true);
...
//                     </h5>
//                     <p className="text-center small">
//                       Enter details of new Mentorship
//                     </p>
//                   </div>
