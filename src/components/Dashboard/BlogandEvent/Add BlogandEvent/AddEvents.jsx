...
const AddEvents = () => {
  ...
  const HandleSubmit = async (e) => {
    e.preventDefault();
    const images = [
      formElEvents.current.elements[1].value,
      formElEvents.current.elements[2].value,
      formElEvents.current.elements[3].value,
    ];
    await axios
      .post(`https://thrivers-assignment-server.onrender.com/EventsRouter`, {
        EventsTitle: formElEvents.current.elements[0].value,
        EventsImages: images,
      })
      .then((res) => {
        if (res.status === 200) {
                ...
                <div className="card-body">
                  ...
                  <div className="pt-4 pb-2">
                    ...
                    <p className="text-center small">
                      Enter details & pictures of new Events
                    </p>
                  </div>
                  ...
                  >
                    <div className="col-md-6 position-relative">
                      <label for="validationTooltip02" className="form-label">
                        Title/Headline of the New Event
                      </label>
                      <input
                        type="text"
                        name="Title"
