...
const AddPartners = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(`https://thrivers-assignment-server.onrender.com/PartnersRouter`, {
        PartnersTitle: formEl.current.elements[0].value,
        PartnersImage: formEl.current.elements[1].value,
        PartnersName: formEl.current.elements[2].value,
        PartnersLink: formEl.current.elements[3].value,
      })
      .then((res) => {
        if (res.status === 200) {
          setSuccess(true);
  ...
  //   await axios
  //     .post(`https://thrivers-assignment-server.onrender.com/PartnersRouter`, {
  //       PartnersTitleTitle: formEl.current.elements[0].value,
  //       PartnersImage: formEl.current.elements[1].value,
  //       PartnersName: formEl.current.elements[2].value,
  //       PartnersLink: formEl.current.elements[3].value,
  //     })
