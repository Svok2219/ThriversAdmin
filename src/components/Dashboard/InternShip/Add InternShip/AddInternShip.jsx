...
const AddInternShip = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(
        `https://thrivers-assignment-server.onrender.com/InternOpeningsRouter`,
        {
          InternshipTitle: formEl.current.elements[0].value,
          InternshipDetails: formEl.current.elements[2].value,
          InternshipImage: formEl.current.elements[1].value,
        }
      )
      .then((res) => {
        if (res.status === 200) {
                ...
                <div className="card-body">
                  ...
                  <div className="pt-4 pb-2">
                    ...
                    <p className="text-center small">
                      Enter details of new InternShip
                    </p>
                  </div>
